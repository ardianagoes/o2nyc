  ...
  return (
    <Box className="community-sensor-project-page">
      ...
      <Box className="project-content">
        ...
        <Box className="mobile-slideshow">
          <Box className="slideshow-container">
            <IconButton onClick={prevImage} className="slideshow-button prev-button" aria-label="Previous slide">
              <ArrowBackIosIcon />
            </IconButton>
            <img 
            ...
            />
            <IconButton onClick={nextImage} className="slideshow-button next-button" aria-label="Next slide">
              <ArrowForwardIosIcon />
            </IconButton>
          </Box>
        </Box>
